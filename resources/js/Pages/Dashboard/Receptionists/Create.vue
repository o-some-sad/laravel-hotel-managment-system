...
const submit = () => {
  ...
  form.post(route('dashboard.receptionists.store'), {
    onSuccess: () => {
...
<template>
  ...
  <DashboardLayout>
    <div class="p-6">
      <div class="mb-6">
        <h1 class="text-2xl font-bold">Create Receptionist</h1>
        <p class="text-muted-foreground">Add a new receptionist to the system</p>
      </div>
      ...
      <Card class="max-w-2xl mx-auto">
        <CardHeader>
          ...
          <CardDescription>
            Enter the details for the new receptionist account
          </CardDescription>
        </CardHeader>
        <CardContent>
