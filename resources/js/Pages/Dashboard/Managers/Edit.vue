...
onMounted(() => {
  if (props.manager.avatar_url) {
    previewImage.value = props.manager.avatar_url;
  }
});
  ...
  <DashboardLayout>
    <div class="p-6">
      <div class="mb-6">
        ...
        <p class="text-muted-foreground">Update manager information</p>
      </div>
      ...
      <Card class="max-w-2xl mx-auto">
        <CardHeader>
          ...
          <CardDescription>
            Update the details for {{ manager.name }}
          </CardDescription>
        </CardHeader>
        <CardContent>
