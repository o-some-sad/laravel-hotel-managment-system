...
<br>
      ...
      <div :class="[
        ...
        <h2 class="text-xl font-semibold">Client Reservations</h2>
        <p :class="[
          'text-sm',
          theme === 'dark' ? 'text-gray-400' : 'text-gray-500'
        ]">View all reservations for your approved clients</p>
      </div>
      ...
      <main :class="[
        ...
        <div :class="[
          ...
          <div class="p-6">
            <Table>
              <TableCaption :class="theme === 'dark' ? 'text-gray-400' : ''">Reservations for clients you have approved</TableCaption>
              <TableHeader>
                <TableRow :class="theme === 'dark' ? 'border-gray-700' : ''">
                  <TableHead :class="theme === 'dark' ? 'text-gray-300' : ''">Client Name</TableHead>
                  <TableHead :class="theme === 'dark' ? 'text-gray-300' : ''">Accompany Number</TableHead>
                  <TableHead :class="theme === 'dark' ? 'text-gray-300' : ''">Room Number</TableHead>
                  <TableHead :class="theme === 'dark' ? 'text-gray-300' : ''">Paid Price</TableHead>
                  <TableHead :class="theme === 'dark' ? 'text-gray-300' : ''">Reservation Date</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                <TableRow v-for="reservation in reservations.data" :key="reservation.id" :class="theme === 'dark' ? 'border-gray-700' : ''">
                  <TableCell :class="theme === 'dark' ? 'text-gray-300' : ''">{{ reservation.client.name }}</TableCell>
                  <TableCell :class="theme === 'dark' ? 'text-gray-300' : ''">{{ reservation.accompany_number }}</TableCell>
                  <TableCell :class="theme === 'dark' ? 'text-gray-300' : ''">{{ reservation.room.number }}</TableCell>
                  <TableCell :class="theme === 'dark' ? 'text-gray-300' : ''">{{ (reservation.paid_price / 100).toFixed(2) }}</TableCell>
                  <TableCell :class="theme === 'dark' ? 'text-gray-300' : ''">{{ new Date(reservation.created_at).toLocaleDateString() }}</TableCell>
                </TableRow>
                <TableRow v-if="reservations.data.length === 0" :class="theme === 'dark' ? 'border-gray-700' : ''">
                  <TableCell colspan="5" class="text-center" :class="theme === 'dark' ? 'text-gray-300' : ''">No reservations found</TableCell>
                </TableRow>
              </TableBody>
            </Table>
            ...
            <div :class="[
                ...
                Total: {{ reservations.total || reservations.data.length }} records
            </div>
            ...
            <div class="flex items-center space-x-1">
                ...
                variant="outline" 
                size="sm" 
                :disabled="(reservations.current_page || 1) <= 1" 
                @click="goToPage((reservations.current_page || 1) - 1)"
                :class="[
                ...
                Page {{ reservations.current_page || 1 }} of {{ reservations.last_page || 1 }}
                </span>
                
                <Button 
                variant="outline" 
                size="sm" 
                :disabled="!(reservations.next_page_url) || (reservations.current_page || 1) >= (reservations.last_page || 1)" 
                @click="goToPage((reservations.current_page || 1) + 1)"
                :class="[
                    theme === 'dark' ? 'bg-gray-700 text-gray-300 border-gray-600' : '',
                    'px-2'
          ...
          <div class="p-6">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <Link :href="route('receptionist.approved-clients')" :class="[
                ...
                <span class="font-medium">Approved Clients</span>
              </Link>
            </div>
          </div>
        </div>
